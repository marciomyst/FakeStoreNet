...
namespace FakeStoreNet.Domain.Tests
{
    ...
    {
        private readonly OrderItem _validItem = new(1, new ValueObjects.Quantity(2));
        ...
        {
            Should.Throw<DomainValidationException>(() => new Order(0, [_validItem]))
        ...
        {
            Should.Throw<DomainValidationException>(() => new Order(1, []))
        ...
        {
            var order = new Order(1, [_validItem]);
